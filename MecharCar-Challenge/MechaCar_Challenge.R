...
MechaCar_mpg <- read.csv("~/Downloads/bootscamp folders/module 16/Starter_Code/MechaCar_mpg.csv")
View(MechaCar_mpg)
...
# Import csv as a DataFrame
Suspension_Coil <- read.csv("~/Downloads/bootscamp folders/module 16/Starter_Code/Suspension_Coil.csv")
